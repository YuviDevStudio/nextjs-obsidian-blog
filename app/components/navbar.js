        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex flex-col items-center justify-center flex-grow space-y-8 p-6">
            <div className="flex space-x-6">
              <Link className="cursor-pointer text-slate-400 hover:text-indigo-600 dark:hover:text-sky-400 transition-all duration-250 transform hover:scale-110" href="https://x.com/jotaedra" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                <svg x="0px" y="0px" width="32" height="32" viewBox="0 0 30 30" fill="currentColor" aria-hidden="true">
                  <path d="M26.37,26l-8.795-12.822l0.015,0.012L25.52,4h-2.65l-6.46,7.48L11.28,4H4.33l8.211,11.971L12.54,15.97L3.88,26h2.65 l7.182-8.322L19.42,26H26.37z M10.23,6l12.34,18h-2.1L8.12,6H10.23z"></path>
                </svg>
              </Link>
              <Link className="cursor-pointer text-slate-400 hover:text-indigo-600 dark:hover:text-sky-400 transition-all duration-250 transform hover:scale-110" href="https://facebook.com/jotaedra" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              ...
              <Link className="cursor-pointer text-slate-400 hover:text-indigo-600 dark:hover:text-sky-400 transition-all duration-250 transform hover:scale-110" href="https://instagram.com/jotaedra" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
