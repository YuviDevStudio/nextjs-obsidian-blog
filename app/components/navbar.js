...
export default function Navbar({ searchPosts = [] }) {
  ...
  return (
    <>
      <nav
        className={`sticky top-0 z-50 w-full transition-all duration-300 ease-in-out border-b backdrop-blur-md isolate ${navbarVisible ? 'translate-y-0' : '-translate-y-full'} bg-white/90 border-slate-200 shadow-slate-100/50 dark:bg-slate-900/80 dark:border-slate-800/80 dark:shadow-slate-950/20 shadow-sm`}
      >
        <div className="w-full max-w-[1340px] mx-auto px-4 md:px-6 py-3 flex items-center justify-between gap-2 relative z-10">
          ...
          <div className="flex-grow text-center flex justify-center min-w-0">
            <Link
              className="cursor-pointer select-none touch-manipulation !no-underline text-2xl font-bold tracking-wider font-display bg-gradient-to-r from-indigo-600 via-indigo-500 to-violet-600 dark:from-sky-400 dark:via-sky-300 dark:to-indigo-400 bg-clip-text text-transparent hover:opacity-90 transition-opacity"
              href="/"
            >
              <span>J</span>
              <i className="text-red-700">ota</i>
              <span>EDRA</span>
            </Link>
          </div>
      ...
      >
        <div className="flex flex-col h-full">
          <div className="p-4 md:p-6 flex items-center justify-between border-b border-slate-100 dark:border-slate-800">
            <Link
              className="cursor-pointer !no-underline text-xl font-bold font-display bg-gradient-to-r from-indigo-600 to-violet-600 dark:from-sky-400 dark:to-indigo-400 bg-clip-text text-transparent"
              href="/"
              onClick={toggleMenu}
            >
              <span>J</span>
          ...
          <div className="p-4 md:p-6" ref={searchRef}>
            <SearchBox
              posts={searchPosts}
              placeholder="Buscar..."
          ...
          <nav aria-label="Menú principal" className="px-4 md:px-6">
            <ul className="space-y-1">
              <li>
                <Link
                  href="/"
                  onClick={toggleMenu}
                  className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-700 hover:bg-slate-100 hover:text-indigo-600 dark:text-slate-200 dark:hover:bg-slate-800 dark:hover:text-sky-400 transition-colors"
                >
          ...
          <div className="flex flex-col items-center justify-center flex-grow space-y-8 p-6">
            <div className="flex space-x-6">
              <Link
                className="cursor-pointer text-slate-400 hover:text-indigo-600 dark:hover:text-sky-400 transition-all duration-250 transform hover:scale-110"
